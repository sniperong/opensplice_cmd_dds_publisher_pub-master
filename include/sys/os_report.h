...
#define OS_REPORT_WID(type,context,code,id,...) \
    (((type) >= os_reportVerbosity) ? os_report_w_domain((type),(context),__FILE__,__LINE__,(code),(id),OS_TRUE,__VA_ARGS__) : (void)0)

#define OS_REPORT_WID_NS(type,context,code,id,...) \
    (((type) >= os_reportVerbosity) ? os_report_w_domain((type),(context),__FILE__,__LINE__,(code),(id),OS_FALSE,__VA_ARGS__) : (void)0)

...
#ifndef _TAO_IDL_DDS_BUILTINTOPICSS_NDB870_H_
#define _TAO_IDL_DDS_BUILTINTOPICSS_NDB870_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::DDS::ProductDataQosPolicy>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::UserKeyQosPolicy>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::TypeHash>
    : public
        Fixed_Size_SArg_Traits_T<
            ::DDS::TypeHash,
            TAO::Any_Insert_Policy_Stream
  ...
  template<>
  class SArg_Traits< ::DDS::TypeBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::CMParticipantBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::CMPublisherBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::CMSubscriberBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::CMDataWriterBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<
  ...
  template<>
  class SArg_Traits< ::DDS::CMDataReaderBuiltinTopicData>
    : public
        Var_Size_SArg_Traits_T<

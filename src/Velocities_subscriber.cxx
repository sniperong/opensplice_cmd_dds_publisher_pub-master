...
Example subscription of type Velocities automatically generated by 
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
           ...
           /*VelocitiesTypeSupport::print_data(&data_seq[i]);
            velocity_msg.linear.x = data_seq[i].linear_velocity_x;
            velocity_msg.linear.y = data_seq[i].linear_velocity_y;
            velocity_msg.angular.z = data_seq[i].angular_velocity_z;
            cmd_vel_publisher.publish(velocity_msg);
            ROS_DEBUG("data received");*/
            printf("%f\n", data_seq[i].linear_velocity_x);
        }
    }
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    int count = 0;
    DDS_Duration_t receive_period = {0,500000000};
    int status = 0;

...
EnvironmentalPluginSupport_create_data_w_params(
    ...
    Environmental *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, Environmental);

    if(sample != NULL) {
        if (!Environmental_initialize_w_params(sample,alloc_params)) {
...
EnvironmentalPluginSupport_create_data_ex(RTIBool allocate_pointers){
    ...
    if(sample != NULL) {
        if (!Environmental_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }
...
{
    return EnvironmentalPluginSupport_create_data_ex(RTI_TRUE);
}
...
EnvironmentalPluginSupport_destroy_data_w_params(
    ...
    Environmental_finalize_w_params(sample,dealloc_params);
...
EnvironmentalPluginSupport_destroy_data_ex(
    ...
    Environmental_finalize_ex(sample,deallocate_pointers);
...
EnvironmentalPluginSupport_destroy_data(
    ...
    EnvironmentalPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return Environmental_copy(dst,src);
}
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        EnvironmentalPluginSupport_create_data,
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = EnvironmentalPlugin_get_serialized_sample_max_size(
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            EnvironmentalPlugin_get_serialized_sample_max_size, epd,
    ...
    void *handle)
{
    ...
    Environmental_finalize_optional_members(sample, RTI_TRUE);
    ...
    const Environmental *src)
{
    ...
    return EnvironmentalPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ...
        Environmental_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    ...
    const Environmental *sample)
{
    ...
    result = EnvironmentalPlugin_serialize(
    ...
    unsigned int length)
{
    ...
    return EnvironmentalPlugin_deserialize_sample( 
        NULL, sample,
    ...
    void *endpoint_plugin_qos)
{
    ...
    result= EnvironmentalPlugin_deserialize_sample( 
...
RTIBool EnvironmentalPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    ...
    unsigned int current_alignment)
{
    ...
    size = EnvironmentalPlugin_get_serialized_sample_max_size_ex(
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_key) {
        ...
        if (!EnvironmentalPlugin_serialize(
            endpoint_data,
            sample,
            stream,
...
RTIBool EnvironmentalPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    Environmental *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (deserialize_key) {
        ...
        if (!EnvironmentalPlugin_deserialize_sample(
...
RTIBool EnvironmentalPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Environmental **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (drop_sample) {} /* To avoid warnings */
    stream->_xTypesState.unassignable = RTI_FALSE;
    result= EnvironmentalPlugin_deserialize_key_sample(
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += EnvironmentalPlugin_get_serialized_sample_max_size_ex(
    ...
    unsigned int current_alignment)
{
    ...
    size = EnvironmentalPlugin_get_serialized_key_max_size_ex(
        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *EnvironmentalPlugin_new(void) 
{ 
    ...
    EnvironmentalPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    EnvironmentalPlugin_destroy_sample;
    ...
    EnvironmentalPlugin_get_sample;
    ...
    EnvironmentalPlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)Environmental_get_typecode();
    ...
    EnvironmentalPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    EnvironmentalPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    EnvironmentalPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = EnvironmentalTYPENAME;

    return plugin;
}

void
EnvironmentalPlugin_delete(struct PRESTypePlugin *plugin)
{

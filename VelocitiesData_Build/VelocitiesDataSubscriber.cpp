...
{
  OS_API_EXPORT
  int VelocitiesDataSubscriber(int argc, char *argv[]);
}

/* Main wrapper to allow embedded usage of the Subscriber application. */
int OSPL_MAIN (int argc, char *argv[])
{
  return VelocitiesDataSubscriber (argc, argv);
}
...
int VelocitiesDataSubscriber(int argc, char *argv[])
{
    ...
    VelocitiesData::VelocitiesSeq msgList;
  ...
  // Create Subscriber entity
    ...
    sQos.partition.name[0] = "VelocitiesData Partition";
  ...
  // create DataReader entity
    ...
    VelocitiesData::VelocitiesDataReader_var VelocitiesDataReader = VelocitiesData::VelocitiesDataReader::_narrow(reader);
    checkHandle(VelocitiesDataReader, "VelocitiesDataReader::_narrow() failed");
...
while (true)
    {
        result = VelocitiesDataReader->take(msgList, infoSeq, DDS::LENGTH_UNLIMITED,
        ...
        result = VelocitiesDataReader->return_loan(msgList, infoSeq);
        checkStatus(result, "VelocitiesDataReader::return_loan() failed");
